...
enum AttributeKindCodes {
  ...
  ATTR_KIND_SANITIZE_CILK = 79,
  ATTR_KIND_STEALABLE = 80,
  ATTR_KIND_STRAND_PURE = 81,
  ATTR_KIND_STRAND_NO_ALIAS = 82,
  ATTR_KIND_INJECTIVE = 83,
  ATTR_KIND_HYPER_VIEW = 84,
  ATTR_KIND_HYPER_TOKEN = 85,
  ATTR_KIND_REDUCER_REGISTER = 86,
  ATTR_KIND_REDUCER_UNREGISTER = 87,
  ATTR_KIND_FORKABLE = 88,
  ATTR_KIND_ULI_NO_POLLING = 89,
  ATTR_KIND_NO_STACKLET_CHECK = 90,
  ATTR_KIND_ULI_NON_ATOMIC = 91,
  ATTR_KIND_NO_UNWIND_PATH = 92,
  ATTR_KIND_USER_LEVEL_INTERRUPT = 93,
};
