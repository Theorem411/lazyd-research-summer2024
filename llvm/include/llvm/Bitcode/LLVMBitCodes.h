...
enum AttributeKindCodes {
  ...
  ATTR_KIND_FORKABLE = 90,
  ATTR_KIND_ULI_NO_POLLING = 91,
  ATTR_KIND_NO_STACKLET_CHECK = 92,
  ATTR_KIND_ULI_NON_ATOMIC = 93,
  ATTR_KIND_NO_UNWIND_PATH = 94,
  ATTR_KIND_USER_LEVEL_INTERRUPT = 95,
};
