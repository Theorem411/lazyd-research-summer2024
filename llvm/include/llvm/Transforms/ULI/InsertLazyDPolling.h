//===- InsertLazyDPolling.h - Emulate ULI intrinsics ---------------------===//
//
...
#ifndef LLVM_TRANSFORMS_INSERTLAZYD_POLLING_H
#define LLVM_TRANSFORMS_INSERTLAZYD_POLLING_H
...
struct InsertLazyDPollingPass : public PassInfoMixin<InsertLazyDPollingPass> {
...
Pass *createInsertLazyDPollingPass();

} // end namespace llvm

#endif // LLVM_TRANSFORMS_INSERTLAZYD_POLLING_H
