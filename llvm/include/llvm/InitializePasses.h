...
void initializeULIIntrinsicToExternCallPass(PassRegistry&);
void initializeULIPollingInsertionPass(PassRegistry&);
...
void initializeLiveVariableWrapperPassPass(PassRegistry&);
void initializeReachingDetachInstWrapperPassPass(PassRegistry&);
void initializeReachingStoreReachableLoadWrapperPassPass(PassRegistry&);
